# Estrutura de Dados
Repositório de provas antigas da Disciplina **Estrutura de Dados** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/estrutura-de-dados.git`
...
`git clone git@github.com:compcederj/estrutura-de-dados.git`
...
# Estrutura de Dados
Repositório de provas antingas da Disciplina **Estrutura de Dados** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
